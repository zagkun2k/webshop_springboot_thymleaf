var ChartsAmcharts = function() {
    ...
    var initChartSample1 = function() {
        ...
        for(var i=0;i<data.length;i++){
                inf[i]={
                    "brand": data[i][0],
                    "income": (data[i][2]/1000000).toFixed(2),
                }
        }
    ...
    var initChartSample3 = function() {
        ...
        for(var i=0;i<data.length;i++){
                inf[i]={
                    "brand": data[i][0],
                    "income": (data[i][2]/1000000).toFixed(2),
                    "expenses": (data[i][5]/1000000).toFixed(2)
                }
        }
    ...
    var initChartSample4 = function() {
        ...
        for(var i=0;i<data.length;i++){
                inf[i]={
                    "month": data[data.length-i-1][0],
                    "income": (data[data.length-i-1][2]/1000000).toFixed(2),
                     "expenses": (data[data.length-i-1][2]/1000000).toFixed(2)
                    // "expenses": (data[i][5]/1000000).toFixed(2)
    ...
    var initChartSample6 = function() {
        ...
        for(var i=0;i<data.length;i++){
                inf[i]={
                    "quarter": data[i][0],
                    "income": (data[i][2]/1000000).toFixed(2),
                     "expenses": (data[i][2]/1000000).toFixed(2)
                    // "expenses": (data[i][5]/1000000).toFixed(2)
    ...
    var initChartSample7 = function() {
        // let data = $(this).closest("div").attr("data");
